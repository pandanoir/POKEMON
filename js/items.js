var Item=(function(){
	var Item=function(name){
		this.name=name;
		this.price=parseInt(itemValue[name].price,10);
...
var itemValue={
	"生命の神秘":{price:0,battle:true,effect:"attack 2",description:"せいめいの しんぴ。わからないこは お父さんに聞こう"},
	...
	"バ○アグラ":{price:6000,battle:true,effect:"attack 2,pp 2",description:""},
